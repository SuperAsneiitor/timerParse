...
def main(argv: list[str] | None = None) -> int:
    ...
    detail_f1_f2 = cmpd / "detail_format1_vs_format2"
    detail_f1_f2.mkdir(parents=True, exist_ok=True)
    run(
        [
            sys.executable,
            "-m",
            ...
            str(ex2 / "path_summary.csv"),
            "-o",
            str(detail_f1_f2 / "compare.csv"),
            "--stats-json",
            str(detail_f1_f2 / "compare_stats.json"),
            "--golden-launch-csv",
            str(ex1 / "launch_path.csv"),
            "--test-launch-csv",
            str(ex2 / "launch_path.csv"),
